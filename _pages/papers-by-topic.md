...
<!--- Links to sessions in the schedule follow each talk. --->


<div id="PapersByTopic">

<h2>Cognitive Architecture and Modeling</h2>

<div id="CA" class="PaperCat">
  <ul>
<li>
<p><a href="/acs2022/data/acs22_paper-4252.pdf">Cognitive Modeling of
  Interpretations of Representations</a> (L)<br />
...
<li>
<p><a href="/acs2022/data/acs22_paper-238.pdf">Representing Motivation in a Simple Perceptual and Motor Coordination Task based on a Goal Activation Mechanism</a> (L)<br />
...
An Integrated Architecture for Common Ground in Collaboration</a> (S)<br />
...
Framework for a multi-dimensional test of theory of mind for humans and AI systems</a> (S)<br />
...
Motion Planning and Continuous Control in a Unified Cognitive Architecture</a> (S)<br />
...
<h2>Intention, Goal Reasoning and Metacognition</h2>

<div id="GR" class="PaperCat">
    <ul>
    
<li>
<p><a href="/acs2022/data/acs22_paper-9367.pdf">Agent Goal Management using Goal Operations</a> (L)<br />
...
<li>
<p><a href="/acs2022/data/acs22_paper-8679.pdf">Taking the Intentional Stance Seriously: A Guide to Progress in Artificial Intelligence</a> (L)<br />
Will Bridewell<br />
...
Real-Time Metacognition and Applications</a> (S)<br />
...
Detecting and Accommodating Novel Types and Concepts in an Embodied Simulation Environment</a> (S)<br />
...
Multi-agent Goal Delegation Using Theory of Mind</a> (P)<br />
...
Transforming Environments to Evaluate Agent Adaptation</a> (P)<br />
...
<h2>Learning, Inference and Analogy</h2>

<div id="IA" class="PaperCat">
    <ul>
    
<li>
  <p><a href="/acs2022/data/acs22_paper-7652.pdf">Ontology Knowledge-enhanced In-Context Learning for Action-Effect Prediction</a> (L)<br />
...
<li>
<p><a href="/acs2022/data/acs22_paper-1295.pdf">Conclusion-Verified Analogical Schema Induction</a> (L)<br />
...
Deductive Reasoning with Incomplete Knowledge via Repeated Analogies</a> (S)<br />
...
Learning from Single and Multi-human intelligence via Cognitive and Reinforcement Learning</a> (S)<br />
...
Towards an Artificial, General Episodic Memory via Learning in Noisy, Perceptually-Aliased Environments</a> (P)<br />
...
Visual Inference Using Homology of Human and Machine Vision Systems</a> (P)<br />
...
A Discourse Interpretation Engine Sensitive to Truth Revisions in a Story</a> (S)<br />
Pablo Gervás<br />
...
Benchmark based Vitality of Axioms and Preconditions for Datalog Theory Repair</a> (S)<br />
...
Contextualized Access to Large-Scale Domain Knowledge for Qualitative Modeling</a> (P)<br />
...
Knowledge Representation Integrating Conditional Probabilities, Context Logic, and Primitives</a> (P)<br />
...
Portals and Spaces: An Egocentric Knowledge Representation for Reasoning About Actions and its Implementation</a> (P)<br />
...
<h2>Learning/Inference with Language Models</h2>

<div id="LM" class="PaperCat">
    <ul>
    <li>
<p><a href="/acs2022/data/acs22_paper-2537.pdf">Efficient Induction of Language Models Via Probabilistic Concept Formation</a> (L)<br />
...
<li>
<p><a href="/acs2022/data/acs22_paper-7038.pdf">A Neuro-Symbolic Cognitive System for Intuitive Argumentation </a> (L)<br />
...
<li>
<p><a href="/acs2022/data/acs22_paper-5758.pdf">Getting Help from the Neighborhood: Local Semantic Averaging for Commonsense Inference in Language Models</a> (L)<br />
...
Interleaving a Symbolic Story Generator with a Neural Network-Based Large Language Model</a> (S)<br />
...
Improving Language Model Prompting in Support of Semi-autonomous Task Learning</a> (P)<br />
...
A Framework for Interactive Natural Language Debugging</a> (S)<br />
...
Script Combination for Enhanced Story Understanding and Story Generation Systems</a> (P)<br />
...
Asking Language Models to Explain Pronoun-Ambiguous Sentences</a> (P)<br />
...
<h2>Decision Making and Problem Solving</h2>

<div id="PS" class="PaperCat">
    <ul>
    <li>
<p><a href="/acs2022/data/acs22_paper-8017.pdf">Dynamic Discounting in Decision-Making</a> (L)<br />
...
LARA – Human-guided collaborative problem solver: Effective integration of learning, reasoning and communication</a> (S)<br />
...
Anticipatory Thinking Assessment: Stress tests using synthetic data</a> (S)<br />
...
Learning Decomposition Methods with Numeric Landmarks</a> (S)<br />
...
Addressing the Scaling Problem for Embodied Symbolic Reasoning</a> (P)<br />
David Sekora<br />
...
Learning a More Efficient Backward-Chaining Reasoner</a> (P)<br />
